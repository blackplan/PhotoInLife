...
<div class="container-fluid">
	...
	<div class="row">
	 <div class="contactme">
		...
		<p class="laph">Нравиться фото? Могу быть вашим фотографом</p>
		<button class="cont-btn cb" onclick ="location.href ='contact.html'" onfocus="this.blur()">Связаться</button>
		<div>
